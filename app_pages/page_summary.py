...
def page_summary_body():
    ...
    st.info(
        ...
        f"growth on the cherry surface ([Claudia Probst and Gary Grove, "
        f"WSU Plant Pathology](https://treefruit.wsu.edu/crop-protection/"
        f"disease-management/cherry-powdery-mildew/#:~:text=Powdery%20mildew%"
        f"20of%20sweet%20and,1))."
        f"**Project Dataset**\n"
